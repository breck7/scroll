...
exports.SnapshotProviderDefault = void 0;
...
class SnapshotProviderDefault {
    ...
    save() {
        ...
        (0, fs_1.writeFileSync)(this.file, snapshotData(this.#snapshot));
    }
    #load() {
        try {
            if (!(0, fs_1.statSync)(this.file).isFile()) {
                throw 'not a file';
            }
            this.#snapshot = (0, require_js_1.req)(this.file);
        }
        catch (er) {
...
exports.SnapshotProviderDefault = SnapshotProviderDefault;
