...
export declare namespace NodeLoaderHooksAPI2 {
    ...
    type GlobalPreloadHook = (context?: {
        port: MessagePort;
    }) => string;
}
...
export declare namespace NodeLoaderHooksAPI3 {
    type InitializeHook = (data: any) => void | Promise<void>;
}
...
export declare function createEsmHooks(tsNodeService: Service): NodeLoaderHooksAPI1 | NodeLoaderHooksAPI2 | NodeLoaderHooksAPI3;
