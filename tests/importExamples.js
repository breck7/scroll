#! /usr/bin/env node
const { SCROLL_SETTINGS_FILENAME, settingsKeywords, ScrollFolder } = require("../scroll.js")
const fs = require("fs")
...
cases.forEach(async url => {
	...
	try {
		fs.mkdirSync(folder)
		fs.writeFileSync(path.join(folder, SCROLL_SETTINGS_FILENAME), settingsKeywords.importFrom + " " + url, "utf8")
